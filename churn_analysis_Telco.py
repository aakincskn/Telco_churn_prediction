...
df = pd.read_csv("/Users/macbook/Desktop/miul/Miuul/6. hafta machine learning/ödevler/untitled folder/TelcoChurn/Telco-Customer-Churn.csv")
df.head()
df.shape
df.info()
...
# Telco customer churn data contains information about a fictitious telecom company that provided home phone and Internet services to 7043 customers in California in the third quarter.
# It includes which customers left, stayed or signed up for service.

# 21 Variable 7043 Observations

# CustomerId : Customer Id
# Gender : Gender
# SeniorCitizen : Whether the client is elderly or not (1, 0)
# Partner : Whether the client has a partner  (YES, NO) ? Being married or not
# Dependents : Whether the client has dependents or not  (Evet, Hayır) (Çocuk, anne, baba, büyükanne)
# tenure :  Number of months the customer stays in the company
...
# StreamingTV : Whether the customer has a TV broadcast (Yes, No, No Internet service) Indicates whether the customer uses the Internet service to broadcast television programmes from a third-party provider
# StreamingMovies : Whether the customer has streaming films (Yes, No, No Internet service) Indicates whether the customer uses the Internet service to stream films from a third-party provider
# Contract : Customer's contract period (Month to month, One year, Two years)
# PaperlessBilling : Whether the customer has a paperless invoice (Yes, No)
# PaymentMethod : Customer's payment method (Electronic cheque, Postal cheque, Bank transfer (automatic), Credit card (automatic))
...
# Each line represents a unique customer.
# Variables include information about customer service, account and demographic data.
# Services for which customers have registered - phone, multiple lines, internet, online security, online backup, device protection, tech support, and streaming TV and movies
...
# TASK 1: EXPLORATORY DATA ANALYSIS
           # Step 1: Please see the general picture.
           # Step 2: Capture numeric and categorical variables.
           # Step 3:  Analyze numeric and categorical variables.
           # Step 4: Analyze the target variable (average of the target variable according to categorical variables, average of numerical variables according to the target variable)
           # Step 5: Analyze outlier observations..
           # Step 6:Analyze missing observations.
           # Step 7: Perform correlation analysis.

# TASK 2: FEATURE ENGINEERING
           # Step 1:  Perform necessary actions for missing and outlier values.
...
df = pd.read_csv("/Users/macbook/Desktop/Miuul/6. hafta machine learning/ödevler/3-telcoChurn(müşteri terk/TelcoChurn/Telco-Customer-Churn.csv")
df.head()
df.shape
df.info()
df.dtypes
...
# TotalChargers is highly correlated with monthly salaries and tenure
...
# Create annual categorical variable from tenure variable
...
# Separation of variables according to their type
cat_cols, num_cols, cat_but_car = grab_col_names(df)
